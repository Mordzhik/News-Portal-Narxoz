      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="about-us.php">Главная </a>
            </li>
                 <li class="nav-item">
              <a class="nav-link" href="index.php">Новости</a>
            </li>
             <li class="nav-item">
              <a class="nav-link" href="document.php">Документы</a>
            </li>
              <a class="nav-link" href="personal.php">Персонал</a>
            </li>
			 <li class="nav-item">
              <a class="nav-link" href="students.php">Студенты</a>
            </li>
			 <li class="nav-item">
              <a class="nav-link" href="phd.php">PHD</a>
            </li>
			 <li class="nav-item">
