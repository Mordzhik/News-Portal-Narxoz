                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Редактировать под категорию</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Админ</a>
                                        </li>
                                        <li>
                                            <a href="#">Под категория </a>
                                        </li>
                                        <li class="active">
                                           Редактировать под категорию
                                        </li>
                                    </ol>
...
<strong>Ошибка!</strong> <?php echo htmlentities($delmsg);?></div>
<?php } ?>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Добавить<i class="mdi mdi-plus-circle-outline" ></i></button>
</a>
 </div>
...
<td colspan="7" align="center"><h3 style="color:red">Записи отсутствуют</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Удалить под категорию</h4>
