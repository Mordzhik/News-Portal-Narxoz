                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Добавить под категорию</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Добавить под категорию </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Описание под котегории</label>
	                                                <div class="col-md-10">
