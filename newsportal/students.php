...
$result= mysql_query( "select tblstudfile.id as pid,tblstudfile.PostTitle as posttitle,tblstudfile.PostFile as postfile,tblstudfile.PostUrl as url from tblstudfile " ) 
