...
$result= mysql_query( "select tblpersonal.id as pid,tblpersonal.PostTitle as posttitle,tblpersonal.PostFile as postfile,tblpersonal.PostUrl as url from tblpersonal " ) 
